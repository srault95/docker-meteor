...
# Install PhantomJS
set -e
apt-get -y install libfreetype6 libfreetype6-dev fontconfig ca-certificates
ARCH=`uname -m`
...
cd /usr/local/share/
curl --continue-at - -k -v -L -O https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-${PHANTOMJS_VERSION}-linux-${ARCH}.tar.bz2
